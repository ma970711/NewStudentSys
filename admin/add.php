    ...
    <div class="weui-cells weui-cells_form">
        <div class="weui-cell">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" type="text" name="v_name"  required="required"/>
            </div>
        </div>
        <div class="weui-cell">
            <div class="weui-cell__hd"><label class="weui-label">志愿者手机号</label></div>
            <div class="weui-cell__bd">
                <input class="weui-input" type="number" name="v_phone"  required="required"/>
            </div>
        </div>
    </div>
    <div class="weui-btn-area">
        <button class="weui-btn weui-btn_primary" type="submit" name="subBtn" id="subBtn">添加</button>
    </div>
</form>
...
if (isset($_POST['v_phone'])) {
    ...
    $stmt=$conn->prepare("INSERT INTO v_info (v_id,v_name,v_phone) VALUES (NULL, ?, ?)");
